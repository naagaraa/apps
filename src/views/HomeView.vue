...
<template>
  <main>
    ...
    <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
      <!-- pengumuman -->
      <div v-show="isVisible" class="bg-red-600 px-4 py-3 text-white">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start rtl:justify-end">
            ...
            <a href="https://flowbite.com" class="flex ms-2 md:me-24">
              ...
              <span
                class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">RUANG Kerja</span>
            </a>
          </div>
    ...
    <section class="main mt-10" :class="[isVisible ? 'mt-16 md:mt-10' : 'mt-0']">
      <div class="p-4 sm:ml-64">
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
          <h1 class="font-bold">content main</h1>
    ...
    <section class="bottom-navigation lg:hidden xl:hidden 2xl:hidden">
