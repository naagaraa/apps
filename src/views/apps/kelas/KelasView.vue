<template>
  <Teleport class="hidden" to="#filter-menu-teleport-component">
    <BottomFilterMenu view-key="kelas" title="Filter Menu Kelas" />
  </Teleport>
  <h1 class="font-bold mb-10">Kelas List By Category</h1>
