<template>
    ...
    <div v-if="isFilterShow">
        <div :class="filterMenuClass"
            ...
            <div
                class="divide-y h-80 px-8 py-10 mb-8 mt-10 divide-gray-100 dark:divide-gray-700 overflow-y-scroll scrollbar-thin scrollbar-thumb-slate-500 scrollbar-track-slate-800">
                <slot />
            </div>
        </div>
    </div>
